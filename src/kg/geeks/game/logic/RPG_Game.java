...
public class RPG_Game {
    ...
    public static void startGame() {
        Boss boss = new Boss(1500, 100, "Zeus");
        Warrior warrior1 = new Warrior(300, 20, "Hercules");
        ...
        Witcher witcher = new Witcher(500, 0, "Geralt" );
        Hacker hacker = new Hacker(228, 18, "Snowden");
    ...
    private static void round(Boss boss, Hero[] heroes) {
        ...
        for (int i = 0; i < heroes.length; i++) {
            if (heroes[i].getHealth() > 0 && boss.getHealth() > 0
                ...
                heroes[i].applySuperPower(boss, heroes, i);
            }
        }
        printStatistics(boss, heroes);
    }
